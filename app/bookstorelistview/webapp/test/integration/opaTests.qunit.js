...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "bookstorelistview/test/integration/FirstJourney",
    "bookstorelistview/test/integration/BooksListJourney",
    "bookstorelistview/test/integration/BooksObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
